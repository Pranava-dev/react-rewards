...
const Filter =({transactions,setFilteredTransactions})=>{
  ...
  return(
    ...
    <Stack direction={{xs:'column' ,sm:'row'}} spacing={2} alignItems="center">
        <TextField label="Start Month" slotProps={{
            inputLabel:{shrink:true}
        }}type="month" value={startMonth} sx={{minWidth:180}}  onChange={(e)=>setStartMonth(e.target.value)}/>
        <TextField label="End Month" slotProps={{
            inputLabel:{shrink:true}
        }}type="month" value={endMonth} sx={{minWidth:180}} onChange={(e)=>setEndMonth(e.target.value)}/>
